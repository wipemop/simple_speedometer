...
extern const char* SPEEDOMETER_VISIBLE_ALWAYS;
extern const char* SPEEDOMETER_VISIBLE_ON_FOOT;
extern const char* SPEEDOMETER_VISIBLE_MOUNTED;
...
extern const char* MUTED_SPEEDOMETER_FONT_SIZE;
extern const char* TIMER_AUX_FONT_SIZE;
extern const char* COORDINATE_EDITOR_FONT_SIZE;
...
namespace Settings
{
	...
	extern bool optionSpeedoVisAlways;
	extern bool optionSpeedoVisFoot;
	extern bool optionSpeedoVisMount;
	...
	extern float MutedFontSize;
	extern float AuxWindowFontSize;
	extern float CoordEditFontSize;
